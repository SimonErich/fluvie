...
- The assets live in `web/landing/media/<key>.{mp4,webm,poster.webp,gif}`. They are
  generated by `tool/web/regenerate_gallery.sh` (or `melos run web:gallery`). See
  `web/landing/MAINTAINING.md` for how and when to regenerate.
...
- The maintenance guide: [`web/landing/MAINTAINING.md`](MAINTAINING.md).

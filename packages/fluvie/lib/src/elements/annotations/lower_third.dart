...
/// own. Over its [slideIn] window the bar
/// slides in horizontally from the left and settles, so it reads as arriving;
/// with no [slideIn] it sits in place at every frame.
///
/// ```dart
/// LowerThird(name: 'Ada Lovelace', title: 'Mathematician', slideIn: 12.frames);
/// ```
///

...
void main() {
  group('''Spotify Wrapped Templates''', () {
    testWidgets('''Intro template renders with data''', skip: true,
        (tester) async {
    ...
    testWidgets('''Ranking template renders with items''', skip: true,
        (tester) async {
    ...
    testWidgets('''Collage template renders images''', skip: true,
        (tester) async {
    ...
    testWidgets('''Thematic template renders content''', skip: true,
        (tester) async {
    ...
    testWidgets('''Conclusion template renders summary''', skip: true,
        (tester) async {
    ...
    testWidgets('''Templates can be converted to scenes''', skip: true,
        (tester) async {
      await iHaveAnIntrodataWithTitleYour2024(tester);
      await iCreateATheneongateTemplateWithTheData(tester);
    ...
    testWidgets('''Templates support custom themes''', skip: true,
        (tester) async {
      await iHaveAnIntrodataWithTitleYour2024(tester);

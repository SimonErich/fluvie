...
/// Usage: the first child should start animating
Future<void> theFirstChildShouldStartAnimating(WidgetTester tester) async {
  ...
  // At frame 0, the first child should be starting its animation

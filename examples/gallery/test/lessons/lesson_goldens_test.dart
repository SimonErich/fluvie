...
Future<void> main() async {
  for (final lesson in lessons) {
    // A generative lesson needs a fake generative resolver; it has its own golden
    // (lesson_13_generative_golden_test.dart) rather than the shared media path.
    if (collectGenerativeSources(lesson.video().scenes).isNotEmpty) continue;

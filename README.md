...
| [`ai_abstracted`](packages/ai_abstracted) | One set of contracts for every AI provider and medium; the layer `fluvie_ai` builds on. | [![pub](https://img.shields.io/pub/v/ai_abstracted.svg)](https://pub.dev/packages/ai_abstracted) |
